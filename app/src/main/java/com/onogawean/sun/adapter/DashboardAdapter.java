...
import com.onogawean.sun.fragment.PertemuanFragment;
...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.MyViewHolder> {
    ...
    public DashboardAdapter(List<String> arr) {
        this.arr = arr;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.matkulCard.setOnClickListener((v)->{
            Fragment pertemuanFragment = new PertemuanFragment();
            Bundle bundle = new Bundle();
            bundle.putString("matakuliah", String.valueOf(position));
            bundle.putString("nama_matkul", (String) holder.matkulName.getText());
            pertemuanFragment.setArguments(bundle);

            ((FragmentActivity) v.getContext()).getSupportFragmentManager().beginTransaction()
                    .replace(R.id.main_fragment, pertemuanFragment)
                    .commit();
        });
    }
